  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      {Array.from({ length: 8 }).map((_, i) => (
        <div key={i} className="bg-dark2 rounded-xl overflow-hidden border border-subtle animate-pulse">
    ...
    <main>
      ...
      <section className="px-[5%] py-16 bg-dark">
        {usingFallback && !loading && (
          <p className="text-center text-sm text-subtle mb-8 px-4 py-3 rounded-lg
                        bg-dark2 border border-subtle max-w-xl mx-auto">
            ...
            <button
              ...
              className={`px-6 py-2 rounded-full border-2 text-sm font-bold cursor-pointer transition-all duration-200
                ${activeTab === t.key
                  ...
                  : 'bg-transparent text-muted border-[color:var(--gold-border)] hover:bg-gold hover:text-[#111] hover:border-gold'}`}
            >
              {t.label}
            </button>
          ))}
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-sm text-subtle">Try another tab or check back soon.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filtered.map(item => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-xs text-subtle mb-4 leading-relaxed line-clamp-2">{item.description}</p>
                    ...
                    <button
                      ...
                      className={`w-9 h-9 rounded-full border flex items-center justify-center text-xl font-light
                                  ...
                                  ${added[item.name]
                                    ...
                                    : 'bg-gold-subtle text-gold border-gold hover:bg-gold hover:text-[#111] hover:scale-110'}`}
